...
export const PRICING_TIERS = [
  {
    name: 'MVP',
    description: 'Validate your operations model before you scale',
    price: 5000,
    period: 'one-time',
    features: [
      '2-week sprint to operational MVP',
      'Core dispatch automation setup',
      'Basic AI routing & scheduling',
      'Up to 5 operators onboarded',
  ...
  {
    name: 'Standard',
    description: 'Full operational infrastructure for scaling teams',
    price: 25000,
    period: '/month',
    features: [
      'Complete dispatch automation',
      'Up to 25 operators managed',
  ...
  {
    name: 'Enterprise',
    description: 'White-glove operations from 0 to $XM ARR',
    price: 50000,
    period: '/month',
    features: [
...
export const CLIENT_LOGOS = [
  { name: 'Project Meridian', logo: '/clients/meridian.svg' },
  { name: 'Atlas Home Services', logo: '/clients/atlas.svg' },
  { name: 'Nexus Dispatch', logo: '/clients/nexus.svg' },
  { name: 'Vertex Operations', logo: '/clients/vertex.svg' },
  { name: 'Prime Field Services', logo: '/clients/prime.svg' },
  { name: 'Horizon Logistics', logo: '/clients/horizon.svg' },
] as const;
